...
**Demo instructions can be found here:** [Demo Steps](https://github.com/alainlubin/reference-pattern-aspdotnetcore/tree/master/terraform/aws).
...
Tom Finch tfinch@chef.io, Alain Lubin alubin@chef.io
